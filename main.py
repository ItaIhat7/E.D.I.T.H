...
if __name__ == '__main__':
    print('Hello I am E.D.I.T.H A.I')
    say("Hello I am E.D.I.T.H in the form of AI")
    while True:
        print("Listening...")
        query = takeCommand()
        ...
        apps = [["discord","C:/Users/aryan/AppData/Local/Discord/app-1.0.9016/Discord.exe"],
                ["WhatsApp","C:/Users/aryan/OneDrive/Desktop/WhatsApp.lnk"]]
        for app in apps:
        ...
        if "Sir E.D.I.T.H AI".lower() in query.lower():
            ai(prompt = query)
            say("Yes Sir")
